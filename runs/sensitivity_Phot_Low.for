...
C   NBLOCK:  No. of cells treated per block in structured calculation.
      ...
      IMPLICIT NONE
      INCLUDE '../configs/config_sensitivity_Phot_Low.SOA2'
...
C For Phot_Low run, the high-pressure limit of the product yield is used. 
C
...
C
C Phot_Low variant: uses high-pressure-limit in QY)
