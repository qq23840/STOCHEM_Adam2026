...
C   NBLOCK:  No. of cells treated per block in structured calculation.
      ...
      IMPLICIT NONE
      INCLUDE '../model_files/INOPERVM10_sensitivity_Dist_polar.SOA2'
...
C NH3 (man-related)
     ...
     &       /(14.0*31526000.0)
C HFO1234yf (anthro)
          EMISS(230,I,J)=(CLASS(1,230)/2154.1)*HFOPOLAR(I1,J1)*1E3*NA
     &       /(114.0*31536000.0)
C cHFO1225ye (anthro)
          EMISS(231,I,J)=(CLASS(1,231)/2154.1)*HFOPOLAR(I1,J1)*1E3*NA
     &       /(120.0*31536000.0)
C tHFO1225ye (anthro)
          EMISS(232,I,J)=(CLASS(1,232)/2154.1)*HFOPOLAR(I1,J1)*1E3*NA
     &       /(120.0*31536000.0)
C cHFO1233zd (anthro)
          EMISS(233,I,J)=(CLASS(1,233)/2154.1)*HFOPOLAR(I1,J1)*1E3*NA
     &       /(130.5*31536000.0)
C tHFO1233zd (anthro) HFOPOLAR setup
          EMISS(234,I,J)=(CLASS(1,234)/2154.1)*HFOPOLAR(I1,J1)*1E3*NA
     &       /(130.5*31536000.0)
C cHFO1234ze (anthro)
          EMISS(235,I,J)=(CLASS(1,235)/2154.1)*HFOPOLAR(I1,J1)*1E3*NA
     &       /(114.0*31536000.0)
C tHFO1234ze (anthro) HFOPOLAR setup
          EMISS(236,I,J)=(CLASS(1,236)/2154.1)*HFOPOLAR(I1,J1)*1E3*NA
     &       /(114.0*31536000.0)
C cHFO1336mz (anthro) HFOPOLAR setup
          EMISS(237,I,J)=(CLASS(1,237)/2154.1)*HFOPOLAR(I1,J1)*1E3*NA
     &       /(164.0*31536000.0)
C tHFO1336mz (anthro)
          EMISS(238,I,J)=(CLASS(1,238)/2154.1)*HFOPOLAR(I1,J1)*1E3*NA
     &       /(164.0*31536000.0)
C cHFO1318my (anthro)
          EMISS(239,I,J)=(CLASS(1,239)/2154.1)*HFOPOLAR(I1,J1)*1E3*NA
     &       /(200.0*31536000.0)
C tHFO1318my (anthro)
          EMISS(240,I,J)=(CLASS(1,240)/2154.1)*HFOPOLAR(I1,J1)*1E3*NA
     &       /(200.0*31536000.0)
C HFO1243zf (anthro)
          EMISS(241,I,J)=(CLASS(1,241)/2154.1)*HFOPOLAR(I1,J1)*1E3*NA
     &       /(96.0*31536000.0)
C HFO1438ez (anthro)
          EMISS(242,I,J)=(CLASS(1,242)/2154.1)*HFOPOLAR(I1,J1)*1E3*NA
     &       /(214.0*31536000.0)
C HFO1233xf (anthro)
          EMISS(243,I,J)=(CLASS(1,243)/2154.1)*HFOPOLAR(I1,J1)*1E3*NA
     &       /(130.5*31536000.0)
C HFO1216 (anthro)
          EMISS(244,I,J)=(CLASS(1,244)/2154.1)*HFOPOLAR(I1,J1)*1E3*NA
     &       /(150.0*31536000.0)
C HFC143a (anthro)
