...
C   NBLOCK:  No. of cells treated per block in structured calculation.
      ...
      IMPLICIT NONE
      INCLUDE '../configs/config_sensitivity_Phot_Hi.SOA2'
...
C For Phot_Hi run, the low-pressure limit of the product yield is used. 
C
...
C
C Phot_Hi variant: uses zero pressure limit in QY formula
