...
C   NBLOCK:  No. of cells treated per block in structured calculation.
      ...
      IMPLICIT NONE
      INCLUDE '../model_files/INOPERVM10_sensitivity_AXS_hi.SOA2'
...
C Cross sections interpolated from JPL recommendations (increased by 10%)
      DATA SGCF3CHO/
     &    5*0,0.2024,0.176,0.1518,0.1276,
     &    0.1078,0.0902,0.0814,0.0825,0.0902,
     &    0.1067,0.1298,0.1639,0.2101,0.2739,
     &    0.3564,0.4609,0.594,0.759,0.9515,
     &    1.1924,1.4498,1.749,2.0691,2.3859,
     &    2.7236,2.9887,3.234,3.388,3.5123,
     &    3.4188,3.212,2.915,2.475,2.09,
     &    1.584,1.166,0.6842,0.4675,0.2706,
     &    0.0781,0.0418,60*0/
...
C
C Calculate CF3CHO product yields after flux calculations but before level loop
