...
C   NBLOCK:  No. of cells treated per block in structured calculation.
      ...
      IMPLICIT NONE
      INCLUDE '../model_files/INOPERVM10_sensitivity_AXS_low.SOA2'
...
C Cross sections interpolated from JPL recommendations (reduced by 10%)
      DATA SGCF3CHO/
     &    5*0,0.1656,0.144,0.1242,0.1044,
     &    0.0882,0.0738,0.0666,0.0675,0.0738,
     &    0.0873,0.1062,0.1341,0.1719,0.2241,
     &    0.2916,0.3771,0.486,0.621,0.7785,
     &    0.9756,1.1862,1.431,1.6929,1.9521,
     &    2.2284,2.4453,2.646,2.772,2.8737,
     &    2.7972,2.628,2.385,2.025,1.71,
     &    1.296,0.954,0.5598,0.3825,0.2214,
     &    0.0639,0.0342,60*0/
